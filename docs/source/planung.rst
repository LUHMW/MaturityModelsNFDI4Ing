...
+-------------------------------------------------------+----------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 1.2.2: Ziele, Prioritäten und Umfang des FDM wird     | Identifizierung von forschungsrelevanten Inhalten        |  Die inhaltliche Ausgetsaltung des DMPs orientiert sich an den inhalten des Forschungsprojektes,                                                                          |
|                                                       |                                                          |  hierbei hat sich die einteilung in definierte Datasets, zur strukturierten ausarbeitung bewehrt                                                                          |
