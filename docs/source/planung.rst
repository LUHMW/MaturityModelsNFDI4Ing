...
|                                                       |                                                          |                                                                                                                                                                               |
| FDMs speziell am Forschungsprojekt ausgerichtet sind. | Feldversuche, …)                                         | Zum Teil werden Ressourcen und FDM-Systeme                                                                                                                                    |
|                                                       +----------------------------------------------------------+                                                                                                                                                                               |
| Diese Strategie sollte als integraler Bestandteil     | Kalkulierung und Planung benötigte                       | von Ihrer Universität oder Forschungseinrichtung empfohlen oder betrieben                                                                                                     |
|                                                       |                                                          |                                                                                                                                                                               |
| bei der Antragsstellung betrachtet werden.            | Ressourcen (Kosten, Personal, etc.)                      |                                                                                                                                                                               |
|                                                       +----------------------------------------------------------+                                                                                                                                                                               |
...
+-------------------+--------------------------------------------------+
| Zeile 2, Spalte 1 | * Zeile 2, Spalte 2 mit Zeilenumbruch \| hier ist|
|                   | ein Zeilenumbruch \| in der Zelle                |
+-------------------+--------------------------------------------------+
